...
def main():
    ...
    conversion_amount = convert(amount=amount, source_currency=source_currency,
                                target_currency=target_currency)

    print(f'{amount} {source_currency} is equal to {conversion_amount:.2f} {target_currency}')
